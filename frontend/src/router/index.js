...
const routes = [
  ...
  // Admin
  { path: '/admin',                          name: 'AdminDashboard',     component: () => import('@/views/admin/DashboardView.vue'),       meta: { admin: true } },
  { path: '/admin/produtos',                 name: 'AdminProdutos',      component: () => import('@/views/admin/ProdutosView.vue'),        meta: { admin: true } },
  { path: '/admin/produtos/editar/:id',      name: 'AdminEditarProduto', component: () => import('@/views/admin/EditarProdutoView.vue'),  meta: { admin: true } },
  { path: '/admin/cupons',                   name: 'AdminCupons',        component: () => import('@/views/admin/CuponsView.vue'),         meta: { admin: true } },
  { path: '/admin/cupons/editar/:id',        name: 'AdminEditarCupom',   component: () => import('@/views/admin/EditarCupomView.vue'),    meta: { admin: true } },
  { path: '/admin/vendas/:id',               name: 'AdminDetalhesVenda', component: () => import('@/views/admin/DetalhesVendaView.vue'),  meta: { admin: true } },
