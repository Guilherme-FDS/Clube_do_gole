  ...
  <div class="pagina-institucional">
    <section class="inst-hero">
      <div class="container">
        ...
        <h1 class="titulo-xl">Envio e <span style="color:var(--cor-dourado);">Devoluções</span></h1>
      </div>
    </section>
    <section class="inst-body">
      <div class="container inst-prose">
        ...
        <template v-else>
          <p>As informações sobre envio e devoluções estão sendo atualizadas.</p>
          <p>Para dúvidas, entre em contato pelo e-mail <a href="mailto:contato@clubedogole.com.br">contato@clubedogole.com.br</a> ou pelo WhatsApp.</p>
...
onMounted(async () => {
  try {
    const { data } = await getPagina('envio-devolucoes')
